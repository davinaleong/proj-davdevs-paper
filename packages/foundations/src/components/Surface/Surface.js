 ...
 */
export const Surface = React.forwardRef(({ children, className, level = 'primary', appearance = 'default', elevation = 'none', radius = 'none', padding = 'none', border = 'none', interactive = false, as, ...props }, ref) => {
    ...
    const classes = cn(baseClasses, elevationClasses[elevation], radiusClasses[radius], paddingClasses[padding], borderClasses[border], interactive && 'paper-surface--interactive', className);
