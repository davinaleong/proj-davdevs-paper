...
export const StackShowcase = () => {
  const DemoBox = ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
    <Box className={`p-4 bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded text-center text-gray-900 dark:text-gray-100 ${className}`}>
      {children}
    </Box>
  );
  ...
  return (
    <div className="showcase-content">
      <header className="showcase-header">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Stack</h1>
      ...
      <div className="showcase-section">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Basic Vertical Stack</h2>
      ...
      <div className="showcase-section">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Horizontal Stack</h2>
        <div className="example-container">
          ...
          {(['start', 'center', 'end', 'stretch'] as const).map(align => (
            <div key={align} className="example-container">
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                <Stack gap="sm" align={align} className="h-32 bg-gray-50 dark:bg-gray-800 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {(['start', 'center', 'end', 'between'] as const).map(justify => (
            <div key={justify} className="example-container">
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                <Stack gap="sm" justify={justify} className="h-40 bg-gray-50 dark:bg-gray-800 p-4">
                  <DemoBox className="py-2 px-4 flex-shrink-0">Item 1</DemoBox>
      ...
      <div className="showcase-section">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Horizontal with Wrapping</h2>
        <div className="example-container">
      ...
      <div className="showcase-section">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Nested Stacks</h2>
        <div className="example-container">
