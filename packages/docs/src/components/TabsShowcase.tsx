...
export function TabsShowcase() {
  ...
  const basicTabs: TabItem[] = [
    {
      ...
      content: (
        <div className="p-4 bg-gray-50 dark:bg-gray-950 rounded-lg">
          ...
          <p className="text-gray-500">This is the overview tab content with some sample text.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="p-4 bg-gray-50 dark:bg-gray-950 rounded-lg">
          ...
          <p className="text-gray-500">Detailed information would be displayed here.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="p-4 bg-gray-50 dark:bg-gray-950 rounded-lg">
          ...
          <p className="text-gray-500">Configuration options and preferences.</p>
        </div>
      )
    }
  ];
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-700 dark:text-gray-300 mb-2">Tabs</h1>
        <p className="text-gray-500">Content switching with paper-inspired design</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-500 mb-2">Current active tab: {activeTab1}</p>
            <button 
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Pills</h3>
        ...
        <div>
            ...
            <pre className="showcase-code mt-4">{`import { Tabs } from '@davdevs/paper-basic';
import type { TabItem } from '@davdevs/paper-basic';
