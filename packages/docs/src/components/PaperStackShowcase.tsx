        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <PaperStack interactive rotation={false}>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Try hovering over this card!</p>
            </PaperStack>
            ...
            <PaperStack interactive rotation count={5}>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Layers rotate and lift on hover!</p>
            </PaperStack>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <PaperStack count={4} texture="grain" interactive>
              <div className="space-y-4">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100">Document Collection</h4>
            ...
            <PaperStack count={3} texture="linen" shadow="hard" offset="lg">
              <div className="space-y-4">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100">Design Iterations</h4>
                <p className="text-gray-500">Track multiple versions of your designs with visual depth.</p>
                <div className="flex space-x-2">
                  <span className="px-2 py-1 bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 rounded text-xs">v3.2 Current</span>
                  <span className="px-2 py-1 bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded text-xs">v3.1</span>
                  <span className="px-2 py-1 bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded text-xs">v3.0</span>
                </div>
              </div>
            </PaperStack>
          </div>
