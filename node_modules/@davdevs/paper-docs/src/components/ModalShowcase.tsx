...
const Modal = ({ 
  ...
  return (
    ...
    >
      <div className={`relative bg-white rounded-lg shadow-xl border border-gray-200 ${sizes[size]} ${className}`}>
...
>
  ...
  <div className="flex justify-end space-x-3">
    ...
    <button className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
      ...
      >
        <p>This is a basic modal with some content.</p>
        <p className="mt-4 text-gray-600">You can click outside the modal or press the X button to close it.</p>
      </Modal>
      ...
      >
        <p>This modal has a title in the header.</p>
        <p className="mt-4 text-gray-600">The title helps users understand the purpose of the modal.</p>
        <div className="flex justify-end space-x-3 mt-6">
          <button 
      ...
      >
        ...
        <p className="mt-4 text-gray-600">Perfect for most use cases.</p>
      </Modal>
      ...
      >
        ...
        <p className="mt-4 text-gray-600">Great for forms or detailed information.</p>
        <div className="mt-6 p-4 bg-gray-50 rounded-md">
          <h4 className="font-medium mb-2">Additional Content</h4>
          <p className="text-sm text-gray-600">Large modals can accommodate more complex layouts and multiple sections.</p>
        </div>
      </Modal>
      ...
      >
        ...
        <p className="mt-4 text-gray-600">Ideal for complex forms or rich content.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div className="p-4 bg-blue-50 rounded-md">
            <h4 className="font-medium mb-2">Section 1</h4>
            <p className="text-sm text-gray-600">Extra large modals can utilize grid layouts effectively.</p>
          </div>
          <div className="p-4 bg-green-50 rounded-md">
            <h4 className="font-medium mb-2">Section 2</h4>
            <p className="text-sm text-gray-600">Perfect for side-by-side content arrangement.</p>
          </div>
        </div>
      </Modal>
